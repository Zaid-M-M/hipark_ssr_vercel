    ...
    <>
        <div className='park_inside_spotlight_sec'>
            ...
            <Helmet>
                ...
                <meta property="og:image" content="https://phpstack-725513-2688800.cloudwaysapps.com/cms/wp-content/uploads/2024/10/og_img_park_compliance_pg.webp" />
            </Helmet>
                    ...
                    <div className='row'>
                        <div className='col-12 '>
                            <div className='breadcrum_content'>
                                <h3><Link to='/'>Home</Link>  / <a href='/solutions'> Solutions</a> / PARK COMPLIANCES AND APPROVALS</h3>
                            </div>
                        </div>
                    </div>
                </div>
