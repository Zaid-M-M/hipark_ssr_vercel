...
export default function Koka_eoc() {
  return (
    <>
        <div className='ep_dtls_inner eoc_div'>
            ...
            <div className='eoc_pt1'>
                ...
                <div className='pt1_dv pt1_dv2'>
                    <p>Location:</p>
                    <a class='map_link' href='https://maps.app.goo.gl/mnTh7MMsXfmcR75T8' target='_blank'><p>https://maps.app.goo.gl/mnTh7MMsXfmcR75T8</p></a>
                </div>
            ...
            <div className='eoc_pt2'>
                <div className='pt2_dv pt2_dv1'>
                    <p>Main access:</p>
                    <p>State Highway 15A  (0 km)</p>
                </div>
                <div className='pt2_dv pt2_dv2'>
                    <p>Airport:</p>
                    <p>Delhi Airport  (47 km)</p>
                </div>
