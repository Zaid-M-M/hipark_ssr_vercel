...
export default function Redhills_eoc() {
  return (
    <>
        <div className='ep_dtls_inner eoc_div'>
            ...
            <div className='eoc_pt1'>
                ...
                <div className='pt1_dv pt1_dv2'>
                    <p>Location:</p>
                    <a class='map_link' href='https://maps.app.goo.gl/bVJayqynQ25y2CZe7' target='_blank'><p>https://maps.app.goo.gl/bVJayqynQ25y2CZe7</p></a>
                </div>
            ...
            <div className='eoc_pt2'>
                ...
                <div className='pt2_dv pt2_dv2'>
                    <p>Airport:</p>
                    <p>Hyderabad Airport  (42 km)</p>
                </div>
                <div className='pt2_dv pt2_dv3'>
                    <p>CBD:</p>
                    <p>Hyderabad CBD (47 km)</p>
                </div>
            </div>
