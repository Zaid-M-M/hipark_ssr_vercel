...
export default function Delhi_two_eoc() {
  return (
    <>
        <div className='ep_dtls_inner eoc_div'>
            ...
            <div className='eoc_pt1'>
                ...
                <div className='pt1_dv pt1_dv2'>
                    <p>Location:</p>
                    <a class='map_link' href='https://goo.gl/maps/ZjfisM9cESsB2AER8' target='_blank'><p>https://goo.gl/maps/ZjfisM9cESsB2AER8</p></a>
                </div>
                <div className='pt1_dv pt1_dv3'>
                    <div className='map_cta_inner'>
                        <a target='_blank' href="https://player.vimeo.com/video/962083618?h=4f78527112" className='map_btn'>View Park Video 
            ...
            <div className='eoc_pt2'>
                <div className='pt2_dv pt2_dv1'>
                    <p>Main access:</p>
                    <p>NH 44 (Formerly, NH 1)</p>
                </div>
                <div className='pt2_dv pt2_dv2'>
                    <p>Airport:</p>
                    <p>Delhi Airport  (29 km)</p>
                </div>
