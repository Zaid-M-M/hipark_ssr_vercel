...
export default function Faruknagar_mob_slider_elsc() {
  ...
  return (
    <>
      ...
      {/*--------- Block A ------- */}
      <div className="prk_img_popup" id="div_mob1">
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    ...
                    src={require('../../../../assets/img/elsc_north_pg/Farukhnagar_map/popup_img/Farukhnagar_I.jpg')}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
      ...
      {/*--------- Block C ------- */}
      <div className="prk_img_popup" id="div_mob2">
      <a className="prk_img_popup_close">
            <img
                src={require("../../../../assets/img/elsc_landing_pg/cancel.png")}
            ></img>
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    <img
                    className="elsc_park_map_img epm_img"
                    src={require('../../../../assets/img/elsc_north_pg/Farukhnagar_map/popup_img/Farukhnagar_II.jpg')}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
