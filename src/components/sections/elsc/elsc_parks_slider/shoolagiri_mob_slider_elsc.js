...
export default function Shoolagiri_mob_slider_elsc() {
  ...
  return (
    <>
          ...
          <div className="ep_sld_one">
            ...
            <div className="mob_map_img_dv">
              <div className="ep_map_dv">
                <img
                  src={require("../../../../assets/img/elsc_south_pg/Hosur_map/thumb/hosur-b.jpg")}
                ></img>
        ...
        <div className="ep_sld eps1">
          <div className="ep_sld_one">
            ...
            <div className="mob_map_img_dv">
              <div className="ep_map_dv">
                <img
                  src={require("../../../../assets/img/elsc_south_pg/Hosur_map/thumb/hosur-d.jpg")}
                ></img>
        ...
        <div className="ep_sld eps1">
          <div className="ep_sld_one">
            ...
            <div className="mob_map_img_dv">
              <div className="ep_map_dv">
                <img
                  src={require("../../../../assets/img/elsc_south_pg/Hosur_map/thumb/hosur-e.jpg")}
                ></img>
        ...
        <div className="ep_sld eps1">
          <div className="ep_sld_one">
            ...
            <div className="mob_map_img_dv">
              <div className="ep_map_dv">
                <img
                  src={require("../../../../assets/img/elsc_south_pg/Hosur_map/thumb/hosur-g.jpg")}
                ></img>
      ...
      {/*--------- Block B ------- */}
      <div className="prk_img_popup" id="div_mob15">
            ...
            <React.Fragment>
              ...
              <TransformComponent>
                <img
                  ...
                  src={require("../../../../assets/img/elsc_south_pg/Hosur_map/popup_img/HOSUR B.jpg")}
                ></img>
              </TransformComponent>
            </React.Fragment>
          )}
      ...
      {/*--------- Block D ------- */}
      <div className="prk_img_popup" id="div_mob16">
        <a className="prk_img_popup_close">
          <img
            src={require("../../../../assets/img/elsc_landing_pg/cancel.png")}
          ></img>
          ...
          {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
            <React.Fragment>
              ...
              <TransformComponent>
                <img
                  className="elsc_park_map_img epm_img"
                  src={require("../../../../assets/img/elsc_south_pg/Hosur_map/popup_img/HOSUR D.jpg")}
                ></img>
              </TransformComponent>
            </React.Fragment>
          )}
          ...
          {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
            <React.Fragment>
              ...
              <TransformComponent>
                <img
                  className="elsc_park_map_img epm_img"
                  src={require("../../../../assets/img/elsc_south_pg/Hosur_map/popup_img/HOSUR E.jpg")}
                ></img>
              </TransformComponent>
            </React.Fragment>
          )}
          ...
          {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
            <React.Fragment>
              ...
              <TransformComponent>
                <img
                  className="elsc_park_map_img epm_img"
                  src={require("../../../../assets/img/elsc_south_pg/Hosur_map/popup_img/HOSUR G.jpg")}
                ></img>
              </TransformComponent>
            </React.Fragment>
          )}
