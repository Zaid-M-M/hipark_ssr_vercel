...
export default function Redhills_mob_slider_elsc() {
                        ...
                        <React.Fragment>
                            ...
                            <TransformComponent>
                                <img
                                    ...
                                    src={require('../../../../assets/img/elsc_south_pg/Redhills_map/popup_img/REDHILLS A.jpg')}
                                ></img>
                            </TransformComponent>
                        </React.Fragment>
                    )}
                    ...
                    {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                        <React.Fragment>
                            ...
                            <TransformComponent>
                                <img
                                    className="elsc_park_map_img epm_img"
                                    src={require('../../../../assets/img/elsc_south_pg/Redhills_map/popup_img/REDHILLS B.jpg')}
                                ></img>
                            </TransformComponent>
                        </React.Fragment>
                    )}
