...
export default function Bilaspur_mob_slider_elsc() {
  ...
  return (
    <>
      ...
      <div className='prk_img_popup' id='div_mob7'>
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    ...
                    src={require("../../../../assets/img/elsc_north_pg/Bilaspur_map/popup_img/Bilaspur-f.jpg")}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
      ...
      <div className='prk_img_popup' id='div_mob8'>
      <a className="prk_img_popup_close">
            <img
                src={require("../../../../assets/img/elsc_landing_pg/cancel.png")}
            ></img>
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    <img
                    className="elsc_park_map_img epm_img"
                    src={require("../../../../assets/img/elsc_north_pg/Bilaspur_map/popup_img/Bilaspur-g.jpg")}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
      ...
      <a className="prk_img_popup_close">
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    <img
                    className="elsc_park_map_img epm_img"
                    src={require("../../../../assets/img/elsc_north_pg/Bilaspur_map/popup_img/Bilaspur-h.jpg")}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
