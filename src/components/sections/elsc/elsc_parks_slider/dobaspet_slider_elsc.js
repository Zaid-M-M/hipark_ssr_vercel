...
export default function Dobaspet_slider_elsc() {
  ...
  return (
    ...
    <div className='prk_img_popup' id='div19'>
        ...
        <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_south_pg/Dobasppet_map/popup_img/DOBASPET A.jpg')}></img>
    </div>
    ...
    <div className='prk_img_popup' id='div20'>
        ...
        <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_south_pg/Dobasppet_map/popup_img/DOBASPET B.jpg')}></img>
    </div>
    ...
    <div className='prk_img_popup' id='div21'>
        ...
        <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_south_pg/Dobasppet_map/popup_img/DOBASPET C.jpg')}></img>
    </div>
    ...
    <div className='prk_img_popup' id='div22'>
        ...
        <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Delhi_II_map/popup_img/Block_A.jpg')}></img>
    </div>
