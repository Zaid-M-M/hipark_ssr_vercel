...
export default function Kothur_slider_elsc() {
  ...
  return (
    ...
    <div className='prk_img_popup' id='div10'>
        ...
        <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_south_pg/Kothur_map/popup_img/KOTHUR B.jpg')}></img>
    </div>
    ...
    <div className='prk_img_popup' id='div11'>
        ...
        <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_south_pg/Kothur_map/popup_img/KOTHUR E.jpg')}></img>
    </div>
    ...
    <div className='prk_img_popup' id='div12'>
        ...
        <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_south_pg/Kothur_map/popup_img/KOTHUR F.jpg')}></img>
    </div>
