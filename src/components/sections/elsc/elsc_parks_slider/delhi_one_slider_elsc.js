  ...
  return (
    <>
      ...
      <div className='prk_img_popup' id='div4'>
        ...
        <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_north_pg/Delhi_I_map/popup_img/Delhi_I.jpg')}></img>
      </div>
      ...
      <div className='prk_img_popup' id='div5'>
        ...
        <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_north_pg/Delhi_I_map/popup_img/Delhi_I-c.jpg')}></img>
      </div>
