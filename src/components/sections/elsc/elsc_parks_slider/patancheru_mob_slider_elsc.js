...
export default function Patancheru_mob_slider_elsc() {
    ...
    return (
        <>
            ...
            {/*--------- Block A ------- */}
            <div className="prk_img_popup" id="div_mob13">
                        ...
                        <React.Fragment>
                            ...
                            <TransformComponent>
                                <img
                                    ...
                                    src={require('../../../../assets/img/elsc_south_pg/Patencheru_map/popup_img/PATANCHERU 4.jpg')}
                                ></img>
                            </TransformComponent>
                        </React.Fragment>
                    )}
            ...
            <div className="prk_img_popup" id="div_mob14">
                <a className="prk_img_popup_close">
                    <img
                        src={require("../../../../assets/img/elsc_landing_pg/cancel.png")}
                    ></img>
                    ...
                    {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                        <React.Fragment>
                            ...
                            <TransformComponent>
                                <img
                                    className="elsc_park_map_img epm_img"
                                    src={require('../../../../assets/img/elsc_south_pg/Patencheru_map/popup_img/PATANCHERU 2B.jpg')}
                                ></img>
                            </TransformComponent>
                        </React.Fragment>
                    )}
