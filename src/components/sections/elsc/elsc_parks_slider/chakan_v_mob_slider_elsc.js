...
export default function Chakan_v_mob_slider_elsc() {
  ...
  return (
    <>
          ...
          <div className="ep_sld_one">
            ...
            <div className="mob_map_img_dv">
              <div className="ep_map_dv">
                <img
                  src={require("../../../../assets/img/elsc_west_pg/chakan_v_map/thumb/chakan-thumb-a.jpg")}
                ></img>
                <div className=" max_btn" target="32">
                  <img
                    src={
                      require("../../../../assets/img/svg/elsc_landing/maximize_btn.svg")}
                  ></img>
                </div>
              </div>
            </div>
        ...
        <div className="ep_sld eps1">
          <div className="ep_sld_one">
            ...
            <div className="mob_map_img_dv">
              <div className="ep_map_dv">
                <img
                  src={require("../../../../assets/img/elsc_west_pg/chakan_v_map/thumb/chakan-thumb-b.jpg")}
                ></img>
        ...
        <div className="ep_sld eps1">
          <div className="ep_sld_one">
            ...
            <div className="mob_map_img_dv">
              <div className="ep_map_dv">
                <img
                  src={require("../../../../assets/img/elsc_west_pg/chakan_v_map/thumb/chakan-thumb-c.jpg")}
                ></img>
        ...
        <div className="ep_sld eps1">
          <div className="ep_sld_one">
            ...
            <div className="mob_map_img_dv">
              <div className="ep_map_dv">
                <img
                  src={require("../../../../assets/img/elsc_west_pg/chakan_v_map/thumb/chakan-thumb-d.jpg")}
                ></img>
        ...
        <div className="ep_sld eps1">
          <div className="ep_sld_one">
            ...
            <div className="mob_map_img_dv">
              <div className="ep_map_dv">
                <img
                  src={require("../../../../assets/img/elsc_west_pg/chakan_v_map/thumb/chakan-thumb-e.jpg")}
                ></img>
            ...
            <React.Fragment>
              ...
              <TransformComponent>
                <img
                  ...
                  src={require("../../../../assets/img/elsc_west_pg/chakan_v_map/popup_img/CHAKAN A.jpg")}
                ></img>
              </TransformComponent>
            </React.Fragment>
          )}
          ...
          {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
            <React.Fragment>
              ...
              <TransformComponent>
                <img
                  className="elsc_park_map_img epm_img"
                  src={require("../../../../assets/img/elsc_west_pg/chakan_v_map/popup_img/CHAKAN B.jpg")}
                ></img>
              </TransformComponent>
            </React.Fragment>
          )}
          ...
          {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
            <React.Fragment>
              ...
              <TransformComponent>
                <img
                  className="elsc_park_map_img epm_img"
                  src={require("../../../../assets/img/elsc_west_pg/chakan_v_map/popup_img/CHAKAN C.jpg")}
                ></img>
              </TransformComponent>
            </React.Fragment>
          )}
          ...
          {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
            <React.Fragment>
              ...
              <TransformComponent>
                <img
                  className="elsc_park_map_img epm_img"
                  src={require("../../../../assets/img/elsc_west_pg/chakan_v_map/popup_img/CHAKAN D.jpg")}
                ></img>
              </TransformComponent>
            </React.Fragment>
          )}
          ...
          {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
            <React.Fragment>
              ...
              <TransformComponent>
                <img
                  className="elsc_park_map_img epm_img"
                  src={require("../../../../assets/img/elsc_west_pg/chakan_v_map/popup_img/CHAKAN E.jpg")}
                ></img>
              </TransformComponent>
            </React.Fragment>
          )}
      ...
      <div className="prk_img_popup" id="div_mob37">
        <a className="prk_img_popup_close">
          <img
            src={require("../../../../assets/img/elsc_landing_pg/cancel.png")}
          ></img>
          ...
          {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
            <React.Fragment>
              ...
              <TransformComponent>
                <img
                  className="elsc_park_map_img epm_img"
                  src={require("../../../../assets/img/elsc_west_pg/chakan_v_map/popup_img/CHAKAN F.jpg")}
                ></img>
              </TransformComponent>
            </React.Fragment>
          )}
      ...
      <div className="prk_img_popup" id="div_mob38">
        <a className="prk_img_popup_close">
          <img
            src={require("../../../../assets/img/elsc_landing_pg/cancel.png")}
          ></img>
          ...
          {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
            <React.Fragment>
              ...
              <TransformComponent>
                <img
                  className="elsc_park_map_img epm_img"
                  src={require("../../../../assets/img/elsc_west_pg/chakan_v_map/popup_img/CHAKAN G.jpg")}
                ></img>
              </TransformComponent>
            </React.Fragment>
          )}
      ...
      <div className="prk_img_popup" id="div_mob39">
        <a className="prk_img_popup_close">
          <img
            src={require("../../../../assets/img/elsc_landing_pg/cancel.png")}
          ></img>
          ...
          {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
            <React.Fragment>
              ...
              <TransformComponent>
                <img
                  className="elsc_park_map_img epm_img"
                  src={require("../../../../assets/img/elsc_west_pg/chakan_v_map/popup_img/CHAKAN H.jpg")}
                ></img>
              </TransformComponent>
            </React.Fragment>
          )}
