...
export default function Venkatapura_mob_slider_elsc() {
    ...
    return (
        <>
            ...
            <div className='prk_img_popup' id='div_mob40'>
                        ...
                        <React.Fragment>
                            ...
                            <TransformComponent>
                                <img
                                    ...
                                    src={require("../../../../assets/img/elsc_west_pg/venkatapura_map/popup_img/Goa-A.jpg")}
                                ></img>
                            </TransformComponent>
                        </React.Fragment>
                    )}
            ...
            <div className='prk_img_popup' id='div_mob41'>
                <a className="prk_img_popup_close">
                    <img
                        src={require("../../../../assets/img/elsc_landing_pg/cancel.png")}
                    ></img>
                    ...
                    {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                        <React.Fragment>
                            ...
                            <TransformComponent>
                                <img
                                    className="elsc_park_map_img epm_img"
                                    src={require("../../../../assets/img/elsc_west_pg/venkatapura_map/popup_img/Goa-B.jpg")}
                                ></img>
                            </TransformComponent>
                        </React.Fragment>
                    )}
