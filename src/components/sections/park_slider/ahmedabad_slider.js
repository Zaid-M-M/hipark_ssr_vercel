...
export default function Ahmedabad_slider() {

  const { data } = useFetch(
    "https://phpstack-725513-2688800.cloudwaysapps.com/cms/wp-json/wp/v2/parks/?categories=3"
  );
  ...
  return (
    <>
      <div className='park_info_dv' id='div2'>
        <div className='park_name_dv'>
            <p className='park_name'>Ahmedabad</p>
            <p className='park_status'><span>0</span> active</p>
