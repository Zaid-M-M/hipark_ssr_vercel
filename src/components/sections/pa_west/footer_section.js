              ...
              <div className="fc_inner">
                ...
                <ul>
                  <li><a href='https://in.linkedin.com/company/horizon-industrial-parks' target='_black'>
                    <img src={require('../../../assets/img/svg/elsc_landing/elsc_Linkedin.svg').default}></img>
                    </a></li>
                  <li><a href='https://www.youtube.com/channel/UCOfvGN61RBCKY48sE8I6mJQ' target='_black'>
                    <img src={require('../../../assets/img/svg/elsc_landing/elsc_youtube.svg').default}></img>
                    </a></li>
                  <li><a href='https://www.instagram.com/horizonindustrialparks/' target='_black'>
                    <img src={require('../../../assets/img/svg/elsc_landing/elsc_instagram.svg').default}></img>
                    </a></li>
                  {/* <li><a>
                    <img src={require('../../../assets/img/svg/elsc_landing/elsc_Facebook.svg').default}></img>
                    </a></li> */}
                </ul>
              </div>
            </div>
