...
import Haryana_parks from './haryana_parks';

export default function Haryana_microblog_inside_sec({ initialData }) {
                        ...
                        <div className='row no_LR_margin' >
                            ...
                            <div className='col-md-12 col-lg-12 col-12 mob_pd_LR tab_pd_LR'>
                                ...
                                <div className='blog_breadcrum_content'>
                                    <h3><a href='/'>Home</a>  /  <a href='/haryana'>Haryana</a> / <span dangerouslySetInnerHTML={{ __html: title.rendered }}></span></h3>
                                </div>
