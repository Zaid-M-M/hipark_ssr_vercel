...
import Delhi_parks from './delhi_parks';

export default function Delhi_microblog_inside_sec({ initialData }) {
    ...
    return (
        <>
            ...
            <div className='blog_inside_Sec mic_blog_sec'>
                        ...
                        <div className='row no_LR_margin' >
                            ...
                            <div className='col-md-12 col-lg-12 col-12 mob_pd_LR tab_pd_LR'>
                                ...
                                <div className='blog_breadcrum_content'>
                                    <h3><a href='/'>Home</a>  /  <a href='/delhi'>Delhi</a> / <span dangerouslySetInnerHTML={{ __html: title.rendered }}></span></h3>
                                </div>
