  ...
  const form = useRef();
    ...
    const sendEmail = (e) => {
        ...
        // }
            ...
            fetch('https://script.google.com/macros/s/AKfycbxXJhArSeSlmo_vFGMp1LPPo1kkRjF8fmgG_i6i98nhaULo3ue2uYXn8Zkq1rlraufW/exec', {
                method: 'POST',
            ...
            emailjs.sendForm('service_e420df4', 'template_decectk', e.target, 'SsPYHKCapw4h-xBn_')
                .then((result) => {
    ...
    useEffect(() => {
        ...
        //   if (url === '/parks-availability') {
            let pg_name = 'Park Availability South';
                ...
                <div className="sec6_connect_frm_dv">
                    <form className="row g-3 conversion_form" ref={form} onSubmit={sendEmail} id='con_form_bx'>
                        ...
                        <div className="col-md-6 conv_frm_spc select_drp">
                            ...
                            <select className='form-control enq_frm_slct park_dropdown elsc_drodwn' name='park_location' id='sector_fld_bk_vst' ref={sectorinput_bk_vst} onFocus={handleFocus}>
                                <option value="" disabled selected>Select your park location</option>
                                <option value="Chakan-V">Chakan V</option>
                                <option value="Venkatapura">Venkatapura</option>
                                <option value="Bhayala">Bhayala</option>
                            </select>
                            <p className='error_msg' id='sector_err_bk_vst'>Please Select park location</p>
                        ...
                        <div className="col-12 conv_frm_spc check_input">
                            <input type="checkbox" className="form-control checkbox" name='checkbox' id='check_status'/>
                            <label className="chck_value" for="checkbox">By clicking submit, you give us your consent to contact and assist you with your enquiry.</label>
                        </div>
