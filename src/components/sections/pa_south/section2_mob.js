...
import Hyderabad_slider from "../elsc/elsc_mob_slider/elsc_mob_hydrabad_slider";
import Bengaluru_slider from "../elsc/elsc_mob_slider/elsc_mob_bengaluru_slider";
import Chennai_slider from "../elsc/elsc_mob_slider/elsc_mob_chennai_slider";
          ...
          <div className="row no_LR_margin">
              ...
              <div className="col-12">
                  ...
                  <div className="tab-content">
                        ...
                        <div id="hyderabad_1" className="tab-pane active show elsc_prk_mob_tab">
                          <Hyderabad_slider/>
                        </div>
